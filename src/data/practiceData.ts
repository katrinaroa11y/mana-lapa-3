...
export const SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    benefits: [
      ...
      'EMDR sesijas ir garākas, lai pārstrādes process varētu noritēt bez steigas un sesijas noslēgumā būtu pietiekami daudz laika mierīgai integrācijai un drošības sajūtu veicinošām praksēm'
    ],
    price: '60 € / sesija',
